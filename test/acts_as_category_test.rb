...
class ScopedCategoryTest < Test::Unit::TestCase
  ...
  def test_scope
    ...
    #assert_equal [@r1, @r2, @r3, @c1n1, @c1n2, @c1n3, @c2n1, @c2n2, @c2n3], Category.roots
    #
    #assert @r2.update_attribute('my_hidden', true)
    #assert_equal [@r1, @r3, @c1n1, @c1n2, @c1n3, @c2n1, @c2n2, @c2n3], Category.roots
    #
    #assert_equal '', @r1.siblings
    #assert_equal '', @c2.categories.roots
    
    #assert_equal '', Category.all.inspect
...
#    assert @r1.update_attribute 'my_hidden', true
#    assert_raises(::RecordNotFound) { Category.permitted.find(@r1.id) }
#    Category.permissions = [@r1.id]
#    assert_equal @r1, Category.permitted.find(@r1.id)
#  end
#  
#  def test_forced_roots_within_association
#    assert_equal [@c1n1, @c1n2, @c1n3], @c1.categories.roots!
#  end
#  
#  def test_forced_roots_within_association_and_permissions
#    assert @c1n2.update_attribute 'my_hidden', true
#    assert_equal [@c1n1, @c1n2, @c1n3], @c1.categories.roots!
#  end
#  
#  def test_roots_within_association
#    assert_equal [@c1n1, @c1n2, @c1n3], @c1.categories.roots
#  end
#  
#  def test_roots_within_association_and_permissions
#    assert @c1n2.update_attribute 'my_hidden', true
#    assert_equal [@c1n1, @c1n3], @c1.categories.roots
#  end
