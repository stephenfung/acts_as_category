...
h4. acts_as_tree provides functionality for trees, but lacks some things:
...
h4. acts_as_list is maybe not exactly what I want either:
...
h4. So I came up with acts_as_category, and this is what it does:
